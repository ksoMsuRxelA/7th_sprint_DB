...
func TestAddGetDelete(t *testing.T) {
	...
	parcelDup, err := store.Get(parcel.Number)
	require.NoError(t, err)
	require.Equal(t, parcel.Client, parcelDup.Client)
	require.Equal(t, parcel.Status, parcelDup.Status)
	require.Equal(t, parcel.Address, parcelDup.Address)
	require.Equal(t, parcel.CreatedAt, parcelDup.CreatedAt)
	// delete
